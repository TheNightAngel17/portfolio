...
summary: Solutions for creating projects & contracts inside of Workday from an external tool.
tags:
    - C#
    - WD Reports
    - WD SOAP APIs
...
During planning, we had


I do think that if we didn't already have the existing Orchestrations from the existing integration, this task likely would have not been completed 
